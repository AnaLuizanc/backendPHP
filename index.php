                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="valida.php" method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="inputUser" type="text" placeholder="name@example.com" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="registrar.php">Precisa de acesso? Envie seus dados!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
